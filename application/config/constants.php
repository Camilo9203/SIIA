...
define('CORREO_SIA', 'acreditaciones@orgsolidarias.gov.co'); // Correo electronico del sia para el contacto
define('CORREO_ATENCION', 'acreditaciones@orgsolidarias.gov.co'); // Correo electronico de ATENCION AL CIUDADANO PRIORIDAD BAJA
define('CORREO_COORDINADOR', 'acreditaciones@orgsolidarias.gov.co'); // Correo electronico de COORDINADOR DE EDUCACION PRIORIDAD MEDIA
define('CORREO_AREA', 'acreditaciones@orgsolidarias.gov.co'); // Correo electronico de COORDINADOR DE AREA PRIORIDAD ALTA
define('CORREO_DIRECTOR', 'acreditaciones@orgsolidarias.gov.co'); // Correo electronico de DIRECTOR NACIONAL PRIORIDAD MUY ALTA

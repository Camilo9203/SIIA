...
class Reportes extends CI_Controller
{
	...
	public function exportarDatosAbiertos() {
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('N1', 'TIPO DE EDUCACION DE LA ENTIDAD');
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('T1', 'CORREO ELECTRONICO ENTIDAD');
		$objPHPExcel->getActiveSheet()->SetCellValue('U1', 'CORREO ELECTRONICO REPRESENTANTE LEGAL');
		$objPHPExcel->getActiveSheet()->SetCellValue('V1', 'NUMERO DE LA RESOLUCION');
		$objPHPExcel->getActiveSheet()->SetCellValue('W1', 'FECHA DE INICIO DE LA RESOLUCION');

...
class InformeActividades extends CI_Controller
{
	...
	public function index()
	{
		...
		// Agregar data al formulario
		$data['docentes'] = $this->DocentesModel->getDocentesValidos($data['usuario_id']);
		$data['solicitudes'] = $this->SolicitudesModel->getSolicitudesAcreditadasOrganizacion($data['usuario_id']);

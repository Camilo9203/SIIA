...
class PHPExcel_Writer_Excel5_Parser
{
    ...
    public function __construct()
    {
        ...
        $this->initializeHashes();      // Initialize the hashes: ptg's and funciones's ptg's
        $this->externalSheets = array();
        $this->references = array();
    }

    /**
     * Initialize the ptg and funciones hashes.
     *
     * @access private
     */
    private function initializeHashes()
    {
        ...
        // Refer to function_locale.pl for non-English funciones names.
        //
        // The array elements are as follow:
        // ptg:   The Excel funciones ptg code.
        // args:  The number of arguments that the funciones takes:
        //           >=0 is a fixed number of arguments.
        //           -1  is a variable  number of arguments.
        // class: The reference, value or array class of the funciones args.
        // vol:   The funciones is volatile.
        //
        $this->functions = array(
            // funciones                  ptg  args  class  vol
            'COUNT'           => array(   0,   -1,    0,    0 ),
            'IF'              => array(   1,   -1,    1,    0 ),
            'ISNA'            => array(   2,    1,    1,    0 ),
    ...
    /**
     * Convert a funciones to a ptgFunc or ptgFuncVarV depending on the number of
     * args that it takes.
     *
     * @access private
     * @param string  $token    The name of the funciones for convertion to ptg value.
     * @param integer $num_args The number of arguments the funciones receives.
     * @return string The packed ptg for the funciones
     */
...
//        }
    ...
    /**
     * This funciones just introduces a ptgParen element in the tree, so that Excel
    ...
    /**
     * It parses a funciones call. It assumes the following rule:
     * Func -> ( Expr [,Expr]* )
     *
     * @access private
     * @return mixed The parsed ptg'd tree on success
    ...
    private function func()
    {
        ...
        /**/
            if ($num_args > 0) {
                if ($this->currentToken == "," || $this->currentToken == ";") {
                    ...
                    throw new PHPExcel_Writer_Exception("Syntax error: comma expected in funciones $function, arg #{$num_args}");
                }
        ...
        if (($args >= 0) and ($args != $num_args)) {
            throw new PHPExcel_Writer_Exception("Incorrect number of arguments in funciones $function() ");
        }

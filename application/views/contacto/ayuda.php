			...
			<div class="col-lg-12 grid-margin stretch-card">
				<div class="card shadow-sm">
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="card border-0 bg-light p-3 h-100">
									...
									<p class="text-muted mb-3">Guía completa sobre cómo utilizar el sistema SIIA.</p>
									<a href="<?php echo base_url("assets/manuales/Manual_Usuario.pdf"); ?>" target="_blank" class="btn btn-outline-primary btn-sm">
						...
						<!-- Administradores en línea -->
						<div class="mt-5">
							<div class="d-flex justify-content-between align-items-center mb-4">
								<h4 class="card-title text-primary mb-0">Administradores en línea</h4>
								<span class="badge badge-info p-2">Soporte técnico</span>
							</div>

							<div class="table-responsive">
								<table id="tabla_super_admins" class="table table-hover">
									<thead>
										<tr class="bg-light">
									...
									<tbody id="tbody">
										...
										foreach ($administradores as $administrador) {
											echo "<tr>";
											echo "<td><div class='d-flex align-items-center'><div class='avatar avatar-sm mr-2 bg-primary text-white'>" . substr($administrador->primerNombreAdministrador, 0, 1) . "</div>$administrador->primerNombreAdministrador $administrador->segundoNombreAdministrador $administrador->primerApellidoAdministrador $administrador->segundoApellidoAdministrador</div></td>";
											//echo "<td><span class='badge badge-light'>$administrador->usuario</span></td>";
											echo "<td><span class='badge badge-light'>$administrador->ext</span></td>";
											echo "<td><button class='btn btn-outline-primary btn-sm'><i class='mdi mdi-message-text-outline'></i> Contactar</button></td>";
											echo "</tr>";
										}
										?>
									</tbody>
						...
						<div class="mt-5 pt-3 border-top">
							<div class="d-flex justify-content-between align-items-center">
								<button class="btn btn-primary btn-sm">
									<i class="mdi mdi-help-circle mr-1"></i> Solicitar soporte
								</button>
							</div>
						</div>
					</div>

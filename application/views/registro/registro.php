...
<?php echo form_open('', array('id' => 'formulario_registro')); ?>
	<!--<button type="button" class="btn btn-primary btn-lg pull-right" data-toggle="modal" data-target="#ayuda_registro">?</button>-->
		<div class="col-md-6">
            ...
            <div class="form-group">
                <label for="nit">NIT de la organización (sin puntos y con DV ######-#): <span class="spanRojo">*</span></label>
                <input type="text" class="form-control" form="formulario_registro" name="nit" id="nit" placeholder="Número NIT de la organización... 899999050-8" required="">
            </div>
            <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel-body c_pol">
                        ...
                        <label>PRINCIPIOS DE LA PROTECCIÓN DE DATOS: </label><p>En el desarrollo, interpretación y  aplicación de  la presente Política, en la Entidad se tendrán en cuenta de manera armónica e integral, los principios que a continuación se establecen:  
                    ...
                    <div class="panel-body c_pol">
                        ...
                        <label>Aviso  de privacidad:</label><p>Comunicación verbal o escrita generada por el Responsable, dirigida al Titular para el tratamiento de sus datos personales, mediante la cual se le informa acerca de la existencia de las políticas de tratamiento de información que le serán aplicables, la forma de acceder a las mismas y las finalidades del tratamiento que se pretende dar a los datos personales.</p>
                        <label>Base de Datos: </label><p>Conjunto organizado de datos personales que sea objeto de tratamiento.</p>
                        <label>Causahabiente: </label><p>persona que ha sucedido a otra por causa del fallecimiento de ésta (heredero).</p>
                        <label>Dato personal: </label><p>Cualquier información vinculada o que pueda asociarse a una o varias personas naturales determinadas o determinables.</p>  
                        <label>Dato público: </label><p>Es el dato que no sea semiprivado, privado o sensible. Son considerados datos públicos, entre otros, los datos relativos al estado civil de las personas, a su profesión u oficio, a su calidad de comerciante o de servidor público. Por su naturaleza, los datos públicos pueden estar contenidos, entre otros, en registros públicos, documentos públicos, gacetas y boletines oficiales y sentencias judiciales debidamente ejecutoriadas que no estén sometidas a reserva.</p>
                        <label>Datos sensibles: </label><p>Se entiende por datos sensibles aquellos  que afectan la intimidad del titular o cuyo uso indebido puede generar su discriminación, tales como que revelen el origen racial o étnico, la orientación política, las convicciones religiosas o filosóficas, la pertenencia a sindicatos, organizaciones sociales, de derechos humanos o que promueva intereses de cualquier partido político o que garanticen los derechos y garantías.</p>
                        <label>Encargado del Tratamiento: </label><p>Persona natural o jurídica, pública o privada, que por sí misma o en asocio con otros, realice el Tratamiento de datos personales por cuenta del responsable del tratamiento.</p>
                        <label>Responsable del Tratamiento: </label><p>Persona natural o jurídica, pública o privada, que por sí misma o en asocio con otros, decida sobre la base de datos y/o el tratamiento de los datos.</p>                        
                        <label>Titular: </label><p>Persona natural cuyos datos personales sean objeto de tratamiento.</p>
                        <label>Tratamiento: </label><p> Cualquier  operación  o  conjunto  de  operaciones  sobre  datos  personales,  tales  como  la  recolección, almacenamiento, uso, circulación o supresión.</p>
                        <label>Transferencia: </label><p>La transferencia de datos tiene lugar cuando el responsable y/o encargado del tratamiento de datos personales, ubicado en Colombia, envía la información o los datos personales a un receptor, que a su vez es responsable del tratamiento y se encuentra dentro o fuera del país.</p>
                        <label>Transmisión: </label><p>Tratamiento de datos personales que implica la comunicación de los mismos dentro o fuera del territorio de la República de Colombia cuando tenga por objeto la realización de un tratamiento por el encargado por cuenta del responsable.</p>
                    </div>
                    <hr/>
                    <div class="panel-body c_pol">
                        <div class="t_pol">

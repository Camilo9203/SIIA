<div class="container"><br>
	...
	<div class="form-group">
		...
		<button class="btn btn-round btn-high text-capitalize pull-right" id="consultarEstadoID">Consultar estado la solicitud <i class="fa fa-eye" aria-hidden="true"></i></button>
    </div>

										...
										<table id="tabla_correos_logs" width="100%" border=0 class="table table-striped table-bordered tabla_form display expandable-table">
											...
											foreach ($correos as $correo):
												...
												if ($correo->error != "Enviado"):
													...
													echo "<td><button class='btn btn-primary ver-error-envio' data-error='$correo->error'>Ver error</button></td>";
												else:
													echo "<td><span class='spanVerde'> Enviado</span></td>";
													echo "<td><button class='btn btn-success disabled' data-error='$correo->error'>Enviado</button></td>";
												endif;
												echo '</tr>';
											endforeach; ?>
											</tbody>

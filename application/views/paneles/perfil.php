...
<div class="container">
	...
	<div class="row justify-content-md-center">
		<div class="col-12 card" id="informacionBasicaPerfil">
			<div class="container">
				...
				<button class="btn btn-siia btn-md submit" style="width: 97%;" name="actualizar_informacion" id="actualizar_informacion">Actualizar información <i class="fa fa-check" aria-hidden="true"></i></button>
				<?php echo form_close(); ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-11 m-3">
					...
					<?php echo form_close(); ?>
					<button class="btn btn-siia btn-sm pull-right submit" style="width: 100%;" name="actualizar_contrasena" id="actualizar_contrasena">Actualizar contraseña <i class="fa fa-check" aria-hidden="true"></i></button>
					<br>
					<br>
					<hr/>
					...
					<?php echo form_close(); ?>
					<button class="btn btn-siia btn-sm pull-right submit" style="width: 100%;" name="actualizar_usuario" id="actualizar_usuario">Actualizar nombre de usuario <i class="fa fa-check" aria-hidden="true"></i></button>
					<br>
					<br>
					<hr/>
				</div>
	...
	<br>
	<!-- Datos inicio sesión -->
	<div class="col-12 card" id="actividad">
		<div class="container">
			<div class="col-md-11 m-3">
				<hr/>

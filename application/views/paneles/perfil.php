				...
				<div class="row">
					<div class="col-md-6 m-3">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" form="formulario_actualizar" name="sigla" id="sigla" placeholder="Sigla de la organización" required="" value="<?php echo $organizacion->sigla; ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="numCedulaCiudadaniaPersona" id="numCedulaCiudadaniaPersona" placeholder="Numero de cédula..." class="form-control" required="" value="<?php echo $informacionGeneral->numCedulaCiudadaniaPersona; ?>">
						</div>
					</div>

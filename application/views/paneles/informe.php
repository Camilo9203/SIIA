...
<div class="container">
	...
	<li>Sus docentes deben estar validados por el administrador.</li>
	<li>Para llenar el informe debe tener todos los datos de los asistentes y todas las especificaciones del curso.</li> 
	<li>Si comienza debe terminar hasta finalizar los asistentes puesto que solo se guardara la información hasta llenar TODOS los asistentes.</li> 
...
<hr>
	...
	<?php 
		foreach ($cursos[0] as $curso) {
			...
			if($curso->cursoGratis == '0'){ echo "<td>No</td>"; }else if($curso->cursoGratis == '1'){ echo "<td>Si</td>"; }
			echo "<td>$curso->departamentoCurso</td>";
			echo "<td>$curso->municipioCurso</td>";
			if($curso->archivoAsistentes != null){echo "<td><a href='".base_url("uploads/asistentes/".$curso->archivoAsistentes."")."'<button class='btn btn-siia'>Ver archivo <i class='fa fa-bars' aria-hidden='true'></i></button></a></td>";}else{echo "<td>Ninguno</td>";}

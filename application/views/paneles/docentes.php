...
<hr/>
	...
	<!--<div class="form-group col-md-12">
		...
		<div class="col-md-6">
			<input type="text" class="form-control" name="" placeholder="Cédula">
		</div>
		<div class="col-md-6">
			<button class="btn btn-danger">Buscar <i class="fa fa-search" aria-hidden="true"></i></button>
		</div>
	</div>-->
	<div class="clearfix"></div>
	<hr/>

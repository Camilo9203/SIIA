	...
	<?php if($data_solicitudes): ?>
		<div class="">
			...
			<div class="form-group">
				<button id='nuevaSolicitud' class='btn btn-siia btn-ls pull-right' data-id=" . $solicitud->idSolicitud . ">
			...
			<table id="" width="100%" border=0 class="table table-striped table-bordered">
				...
				foreach ($data_solicitudes as $solicitud) {
					...
					echo "<td><button id='nuevaSolicitud' class='btn btn-siia btn-sm' data-id=" . $solicitud->idSolicitud . "><i class='fa fa-info' aria-hidden='true'></i></button></td></tr>";
				}
				?>
				</tbody>
			</table>

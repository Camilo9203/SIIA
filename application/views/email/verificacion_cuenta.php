            ...
            <tr>
              <td align="center" valign="top">
                 ...
                 <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    <td align="center" valign="top">
                        <img src="http://acreditacion.orgsolidarias.gov.co/siia/assets/img/siiaheadercorreo.png" width="720" height="157" style="margin:0; padding:0; border:none; display:block;" border="0" class="imgClass" alt="" />
                    </td>
                  </tr>
                </table>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    <td align="center" valign="top">
                        ...
                        <strong><label>Nombre de la organización:</label></strong><p><?php echo $organizacion; ?></p>
                        <strong><label>Número NIT:</label></strong><p><?php echo $nit; ?></p>
                        <strong><label>Correo de contacto:</label></strong><p><?php echo $to; ?></p>
                        <strong><label>Representante legal:</label></strong><p><?php echo $nombre_rep_legal; ?> <?php echo $apellido_rep_legal; ?></p>
                        <strong><label>Nombre de usuario:</label></strong><p><?php echo $nombre_usuario; ?></p>
                  ...
                  <tr>
                    <td align="center" valign="top">
                        <small>Si tiene alguna duda puede comunicarse con nosotros a través de los siguientes canales:
                          <br/>
                          Atención al ciudadano <a target="_blank" href="mailto:atencionalciudadano@orgsolidarias.gov.co">atencionalciudadano@orgsolidarias.gov.co</a>
                          <br/>
                          Chat en página web <a target="_blank" href="http://www.orgsolidarias.gov.co">Organizaciones Solidarias</a> martes y jueves de 9 am a 12 pm.
                          <br/>

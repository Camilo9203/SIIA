<!-- Plantilla de Correo de encuesta de satisfacción -->
								...
								<table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
									<tr>
										<td align="center" valign="top">
											...
											<label>Se ha registrado la respuesta de la encuesta de satisfacción con ID de solicitud: <?php echo $solicitudes_id_solicitud; ?>:</label><br>
											<p>&nbsp;¿Cómo califica en general el trámite de acreditación?: <?php echo $general?></p>
											<p>Si su entidad tuvo contacto con el responsable de la evaluación, ¿Cómo califica su atención?:<br> <?php echo $evaluador; ?></p>
											<p>Déjenos sus comentarios:<br><br><?php echo $comentario; ?></p><br>
											<p>Fecha en la que se diligenció la encuesta: <?php echo $fecha; ?></p>
										</td>
									</tr>
								</table>

            				...
            				<div class="modal-body">
            					<div class="row">
            						...
            						<div id="reenvio_pre">
            							<div class="container">
            								<div class="jumbotron">
            									<p>Si el correo no le llega en los próximos 5 minutos, y no está en la bandeja de spam, por favor, escriba otro correo electrónico (Gmail.com, Outlook.com, Yahoo.com, Hotmail.com), y de click en "Volver a enviar el correo". Si el problema persiste, contactese con <a href="mailto:atencionalciudadano@orgsolidarias.gov.co">atencionalciudadano@orgsolidarias.gov.co</a></p>
            									<div class="clearfix"></div>
            									<hr />
            									<div class="form-group">
            	...
            	<div class="modal fade" id="servicioAtencion" tabindex="-1" role="dialog" aria-labelledby="servicioAtencion">
            		<div class="modal-dialog modal-xl" role="document">
            			<div class="modal-content">
            				...
            				<div class="modal-body">
            					<ul>
            						<li><a href="https://www.orgsolidarias.gov.co/" target="_blank">Página web de la Unidad Administrativa Especial de Organizaciones Solidarias</a></li>
            						<li><a href="mailto:atencionalciudadano@orgsolidarias.gov.co" target="_blank">atencionalciudadano@orgsolidarias.gov.co</a></li>
            			...
            			<div class="container">
            				<div>
            					...
            					<div class="pull-right col-md-4" id="icons-redes">
            						...
            						<a target="_blank" class="icon-rss-footer" title="Fuente RSS" href="https://www.orgsolidarias.gov.co/RSS"></a>
            					</div>
            				</div>
            				<div class="clearfix"></div>
            				<div class="col-md-4">
            				...
            				<div class="col-md-4">
            					...
            					<div class="col-md-10 text-footer-l-i">
            						...
            						<br /><br />
            						<p><a href="mailto:atencionalciudadano@orgsolidarias.gov.co" target="_blank" id="mailto_org" title="atencionalciudadano@orgsolidarias.gov.co"> atencionalciudadano@orgsolidarias.gov.co</a></p>
            					</div>
            				</div>
            				<div class="clearfix"></div>
            				<div class="col-md-12">
            			...
            			<div id="col-md-12" class="text-center">
            				<small>
            					<p title="Unidad Administrativa Especial Organizaciones Solidarias">Copyright © <?php echo date('Y'); ?> UAEOS |
            						<a target="_blank" title="Politicas de Privacidad y Condiciones de Uso" href="http://www.orgsolidarias.gov.co/sites/default/files/archivos/terminos%20de%20uso.pdf">Politicas de Privacidad y Condiciones de Uso</a> | <a title="Administrador" href="<?php echo base_url() ?>admin">Administrador</a> | SIIA v1.0.8.181022-Prod
            					</p>
            				</small>
            			</div>
            		</div>

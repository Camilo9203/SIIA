			...
			<div class="col-md-12 grid-margin">
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-12">
							<!-- Resumen del perfil -->
							<?php $this->load->view('usuario/paginas/perfil/partials/_resumen'); ?>
							<!-- Menu Tabs -->
							...
							<div class="tab-content" id="pills-tabContent">
								...
								<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
									<!-- Imagen Logo -->
									<?php $this->load->view('usuario/paginas/perfil/partials/_logo_organizacion'); ?>
									<!-- Información Básica -->
									<?php $this->load->view('usuario/paginas/perfil/partials/_informacion_basica'); ?>
								</div>
								<!-- Contenido Tab Firma RL -->
								<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
									<?php $this->load->view('usuario/paginas/perfil/partials/_firma_rl'); ?>
								</div>
								<!-- Contenido Tab Cambio de datos de inicio -->
								<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
									<?php $this->load->view('usuario/paginas/perfil/partials/_cambiar_datos_inicio'); ?>
								</div>
								<!-- Contenido Certificados -->
								<div class="tab-pane fade" id="pills-certificados" role="tabpanel" aria-labelledby="pills-certificados-tab">
									<?php $this->load->view('usuario/paginas/perfil/partials/_certificados'); ?>
								</div>
								<!-- Contenido Actividad -->
								<div class="tab-pane fade" id="pills-actividad" role="tabpanel" aria-labelledby="pills-actividad-tab">
									<?php $this->load->view('usuario/paginas/perfil/partials/_actividad'); ?>
								</div>
							</div>
						</div>
					</div>

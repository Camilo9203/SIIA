			...
			<div class="col-md-12 grid-margin">
				<div class="row">
					<div class="col-12 col-xl-8 mb-4 mb-xl-0">
						<h3 class="font-weight-bold">Bienvenido <?php echo $data_organizacion->nombreOrganizacion?></h3>
						<h6 class="font-weight-normal mb-0">¡Sistema Integrado de Información<!----> de Acreditación! Tú tienes <span class="text-primary">3 alertas sin leer!</span></h6>
					</div>
			...
			<div class="col-md-6 grid-margin stretch-card">
				<div class="card tale-bg">
					<div class="card-people mt-auto">
						<img src="<?php echo base_url('assets/img/images/dashboard/people.svg') ?>" alt="people">
				...
				<div class="row">
					<div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
						<div class="card card-light-blue">
							<div class="card-body">
								<p class="mb-4">Numero de clientes</p>
					...
					<div class="col-md-6 stretch-card transparent">
						<div class="card card-light-danger">
							<div class="card-body">
								<p class="mb-4">Resultados prueba</p>

	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="pull-right">
				...
				<a href="<?php echo base_url(); ?>reportes/exportarExcelConteo"  class="btn btn-siia">
					<i class="fa fa-download" aria-hidden="true"></i>
					Estadisticas
				</a>
			...
			<table id="tabla_enProceso_organizacion" width="100%" border=0 class="table table-striped table-bordered tabla_form">
				...
				<?php foreach ($organizacionesAcreditadas as $organizacion): ?>
					<tr>
						...
						<td><textarea class="text-area-ext" readonly><?php echo (isset($organizacion['resoluciones']->cursoAprobado)) ? strtoupper($organizacion['resoluciones']->cursoAprobado) : strtoupper("Falta por actualizar datos...");?></textarea></td>

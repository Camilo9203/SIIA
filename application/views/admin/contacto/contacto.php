<div class="container">
	<div class="col-md-12">
		...
		<hr/>
		<div class="checkbox">
			<label><input type="checkbox" id="contaco_enviar_copia_admin_todos" name="contaco_enviar"> Enviar comunicado a todas la entidades en el SIIA</label>
			<br>
			<label><input type="checkbox" id="contaco_enviar_copia_admin_todos_acre" name="contaco_enviar"> Enviar comunicado a todas la entidades <strong>Acreditadas</strong> en el SIIA</label>
			<br>
		...
		<div id="comunicado">
			...
			<div class="checkbox">
				<label><input type="checkbox" id="contaco_enviar_copia_admin" class="" name=""> Enviar con copia al correo del representante legal</label>
			</div>
		...
		<div class="form-group">
			...
			<br>
			<select id="contacto_prioridad_admin" class="selectpicker form-control show-tick">
		...
		<div class="form-group">
			<label>Asunto:*</label>
			<input class="form-control" id="contacto_asunto_admin" type="text" name="" placeholder="Asunto...">
		</div>
		<div class="form-group">
			<label>Mensaje:*</label>

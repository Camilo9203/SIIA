<div id="" class="col-md-5 center-block">
	...
	<div class="form-group">
		<button class="btn btn-default form-control" id="reporte_org_acreditadas">Estadisticas del Tramite</button>
	</div>
	<div class="form-group">
		<button class="btn btn-default form-control" id="reporte_org_historico">Estadisticas de la acreditación</button>
	</div>
	<div class="form-group">

...
--
-- Servidor: localhost
-- Tiempo de generación: 19-05-2022 a las 06:08:00
...
CREATE TABLE `administradores` (
  `id_administrador` int(11) NOT NULL COMMENT 'Id del Administrador',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabla de Administradores';
...
--
-- Estructura de tabla para la tabla `antecedentesacademicos`
--

CREATE TABLE `antecedentesacademicos` (
  `id_antecedentesAcademicos` int(11) NOT NULL COMMENT 'Id tabla Antecedentes Academicos',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario # 4 de SIA Antecedentes Academicos.';
...
CREATE TABLE `archivos` (
  `id_archivo` int(11) NOT NULL COMMENT 'Id Tabla Archivo',
  ...
  `organizaciones_id_organizacion` int(11) NOT NULL COMMENT 'FK Id_Organizacion'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Archivos donde se guardan los archvios subidos por el usuario';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `archivosdocente`
--

CREATE TABLE `archivosdocente` (
  `id_archivosDocente` int(11) NOT NULL COMMENT 'Id Tabla Archivos Docente',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Archivos del docente ';
...
--
-- Estructura de tabla para la tabla `bateriaobservaciones`
--

CREATE TABLE `bateriaobservaciones` (
  `id_bateriaObservaciones` int(11) NOT NULL,
...
CREATE TABLE `certificaciones` (
  `id_certificacion` int(11) NOT NULL COMMENT 'Id Tabla Certificacion',
...
--
-- Estructura de tabla para la tabla `correosregistro`
--

CREATE TABLE `correosregistro` (
  `id_correosRegistro` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `datosaplicacion`
--

CREATE TABLE `datosaplicacion` (
  `id_datosAplicacion` int(11) NOT NULL COMMENT 'Id tabla Datos Aplicacion',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario #10 SIA';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `datosbasicosprogramas`
--

CREATE TABLE `datosbasicosprogramas` (
  `id_datosBasicosProgramas` int(11) NOT NULL COMMENT 'Id tabla datos basicos programas',
...
CREATE TABLE `docentes` (
  `id_docente` int(11) NOT NULL COMMENT 'Id Tabla Docente',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario #9 SIA';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `documentacionlegal`
--

CREATE TABLE `documentacionlegal` (
  `id_documentacionLegal` int(11) NOT NULL COMMENT 'Id de la tabla Documentacion Legal',
  ...
  `solicitudes_id_solicitud` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario # 2 de SIA Documentacion Legal.';
...
--
-- Estructura de tabla para la tabla `historialpersonascapacitadas`
--
...
--
-- Estructura de tabla para la tabla `historialresoluciones`
--

CREATE TABLE `historialresoluciones` (
  `id_historialResoluciones` int(11) NOT NULL,
...
CREATE TABLE `informaciongeneral` (
  `id_informacionGeneral` int(11) NOT NULL COMMENT 'Id tabla informacion general',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario # 1 de SIA Informacion General.';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `informeactividades`
--

CREATE TABLE `informeactividades` (
  `id_informeActividades` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `jornadasactualizacion`
--

CREATE TABLE `jornadasactualizacion` (
  `id_jornadasActualizacion` int(11) NOT NULL COMMENT 'Id Tabla Jornadas de Actualziacion',
  ...
  `solicitudes_id_solicitud` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario #5 de SIA';
...
--
-- Estructura de tabla para la tabla `nits_db`
--

CREATE TABLE `nits_db` (
  `idnits_db` int(11) NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Las notificaciones internas de la aplicación';
...
CREATE TABLE `observaciones` (
  `id_observacion` int(11) NOT NULL COMMENT 'Id Tabla Observaciones',
  ...
  `solicitudes_id_solicitud` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Observaciones que se hacen a los Formularios que el usuario diligencio';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `observacionesdocente`
--

CREATE TABLE `observacionesdocente` (
  `id_observacionesDocente` int(11) NOT NULL,
...
CREATE TABLE `organizaciones` (
  `id_organizacion` int(11) NOT NULL COMMENT 'Id Registro de la Organizacion',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Primer registro de las organizaciones';

--
-- Volcado de datos para la tabla `organizaciones`
--

INSERT INTO `organizaciones` (`id_organizacion`, `nombreOrganizacion`, `numNIT`, `sigla`, `primerNombreRepLegal`, `segundoNombreRepLegal`, `primerApellidoRepLegal`, `segundoApellidoRepLegal`, `direccionCorreoElectronicoOrganizacion`, `direccionCorreoElectronicoRepLegal`, `primerNombrePersona`, `primerApellidoPersona`, `imagenOrganizacion`, `firmaRepLegal`, `contrasena_firma`, `camaraComercio`, `firmaCert`, `personaCert`, `cargoCert`, `asignada`, `estado`, `usuarios_id_usuario`) VALUES
(572, 'Fundacion Pruebas', '1026279129', 'FunPruebas', 'Christian', 'Camilo', 'Rios', 'Hernandez', 'camilorios92@hotmail.com', 'camilorios92@hotmail.com', 'Camilo', 'Rios', 'default.png', 'default.png', NULL, 'default.pdf', 'default.png', 'Nombre Persona', 'Representante Legal', 'SIN ASIGNAR', NULL, 199);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `organizacioneshistorial`
--

CREATE TABLE `organizacioneshistorial` (
  `id_organizacionHistorial` int(11) NOT NULL COMMENT 'Id Registro de la Organizacion',
  `nombreOrganizacion` varchar(1000) NOT NULL COMMENT 'Nombre de la Organizacion',
  `numNIT` varchar(1000) NOT NULL COMMENT 'Numero NIT de la Organizacion',
  `sigla` varchar(1000) NOT NULL DEFAULT '' COMMENT 'Sigla de la organizacion',
  `primerNombreRepLegal` varchar(1000) NOT NULL COMMENT 'Primer Nombre del Representante Legal',
...
--
-- Estructura de tabla para la tabla `planmejoramiento`
--

CREATE TABLE `planmejoramiento` (
  `id_planMejoramiento` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `programasavalar`
--

CREATE TABLE `programasavalar` (
  `id_programasAvalar` int(11) NOT NULL COMMENT 'Id Tabla Programas a Avalar',
  ...
  `solicitudes_id_solicitud` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario #8 SIA';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `programasavaleconomia`
--

CREATE TABLE `programasavaleconomia` (
  `id_programasAvalEconomia` int(11) NOT NULL COMMENT 'Id Tabla Programas Aval Economia Solidaria',
  `objetivos` longtext NOT NULL COMMENT 'Objetivos del Programa',
  `metodologia` longtext NOT NULL COMMENT 'Metodologia del Programa',
  ...
  `solicitudes_id_solicitud` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario #7 SIA';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `registroeducativoprogramas`
--

CREATE TABLE `registroeducativoprogramas` (
  `id_registroEducativoPro` int(11) NOT NULL COMMENT 'Id tabla Registro educativo',
  ...
  `solicitudes_id_solicitud` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Formulario # 3 de SIA Registro Educativo de Programas.';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `registrotelefonico`
--

CREATE TABLE `registrotelefonico` (
  `id_registroTelefonico` int(11) NOT NULL,
...
CREATE TABLE `resoluciones` (
  `id_resoluciones` int(11) NOT NULL,
  `fechaResolucionInicial` date DEFAULT NULL,
  `fechaResolucionFinal` date DEFAULT NULL,
  `añosResolucion` int(11) DEFAULT NULL,
  `resolucion` varchar(1000) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `seguimientosimple`
--

CREATE TABLE `seguimientosimple` (
  `id_seguimientoSimple` int(11) NOT NULL,
...
CREATE TABLE `session_log` (
  `id_session_log` int(11) NOT NULL COMMENT 'Id se Session Log',
...
CREATE TABLE `solicitudes` (
  `id_solicitud` int(11) NOT NULL COMMENT 'Id Tabla Solicitudes',
  ...
  `organizaciones_id_organizacion` int(11) NOT NULL,
  `organizaciones_numNIT` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabla de numero de solicitudes';

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tiposcursoinformes`
--

CREATE TABLE `tiposcursoinformes` (
  `id_tiposCursoInformes` int(11) NOT NULL,
...
CREATE TABLE `tiposolicitud` (
  `id_tipoSolicitud` int(11) NOT NULL COMMENT 'Id tabla tipo solicitud',
  ...
  `solicitudes_id_solicitud` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tipo de la Solicitud del Usuario';
...
CREATE TABLE `token` (
  `id_token` int(11) NOT NULL COMMENT 'Id Token del usuario',
...
INSERT INTO `token` (`id_token`, `token`, `verificado`, `usuario_token`, `fechaActivacion`) VALUES
(199, '$2a$60$D1RlBkteUqnZyst1pa4cQC1Alwd4av142wxxX3OVxkTkzr9kxgXZUKiMED0Gq7YYOFk=', '0', 'camilo9203', NULL);
...
INSERT INTO `usuarios` (`id_usuario`, `usuario`, `contrasena`, `contrasena_rdel`, `logged_in`, `token_id_token`) VALUES
(199, 'camilo9203', '$2a$10$43Y4LAjG.gg6Xta8vLsq2uYNuU/Y9eshlTNNQ5mpAww.DZQ4s4zry', 'lApG2uri15RjBBornuvHHqtV6khWjnT15z/yAyY0MvP9MvH+6Mk4wVVHBtdLrLy15Tusm4vNgSSC6JUEFMI+HuZvpxIO5E5ZSlwiiVcdAopSA7FB0VrMLoBMMqJSZfsa|5x75jXlGiJkEktQr5fzZ1i/FgojeaxLaRxeN0h4Msx8=', '0', 199);
...
--
-- Indices de la tabla `antecedentesacademicos`
--
ALTER TABLE `antecedentesacademicos`
  ADD PRIMARY KEY (`id_antecedentesAcademicos`),
  ADD KEY `fk_antecedentesAcademicos_organizaciones1_idx` (`organizaciones_id_organizacion`);
...
ALTER TABLE `archivos`
  ...
  ADD KEY `fk_archivos_organizaciones1_idx` (`organizaciones_id_organizacion`);

--
-- Indices de la tabla `archivosdocente`
--
ALTER TABLE `archivosdocente`
  ADD PRIMARY KEY (`id_archivosDocente`),
  ADD KEY `fk_archivosDocente_docentes1_idx` (`docentes_id_docente`);
...
ALTER TABLE `asistentes`
  ...
  ADD KEY `fk_asistentes_informeActividades1_idx` (`informeActividades_id_informeActividades`);

--
-- Indices de la tabla `bateriaobservaciones`
--
ALTER TABLE `bateriaobservaciones`
  ADD PRIMARY KEY (`id_bateriaObservaciones`);
...
ALTER TABLE `certificaciones`
  ...
  ADD KEY `fk_certificaciones_informeActividades1_idx` (`informeActividades_id_informeActividades`);

--
-- Indices de la tabla `correosregistro`
--
ALTER TABLE `correosregistro`
  ADD PRIMARY KEY (`id_correosRegistro`);

--
-- Indices de la tabla `datosaplicacion`
--
ALTER TABLE `datosaplicacion`
  ADD PRIMARY KEY (`id_datosAplicacion`),
  ADD KEY `fk_datosAplicacion_solicitudes1_idx` (`solicitudes_id_solicitud`);

--
-- Indices de la tabla `datosbasicosprogramas`
--
ALTER TABLE `datosbasicosprogramas`
  ADD PRIMARY KEY (`id_datosBasicosProgramas`),
  ADD KEY `fk_datosBasicosProgramas_solicitudes1_idx` (`solicitudes_id_solicitud`);
...
ALTER TABLE `docentes`
  ...
  ADD KEY `fk_docentes_organizaciones1_idx` (`organizaciones_id_organizacion`);

--
-- Indices de la tabla `documentacionlegal`
--
ALTER TABLE `documentacionlegal`
  ADD PRIMARY KEY (`id_documentacionLegal`),
  ADD KEY `fk_documentacionLegal_solicitudes1_idx` (`solicitudes_id_solicitud`);
...
ALTER TABLE `encuesta`
  ...
  ADD KEY `fk_encuesta_solicitudes1_idx` (`solicitudes_id_solicitud`);
...
--
-- Indices de la tabla `historialpersonascapacitadas`
--
ALTER TABLE `historialpersonascapacitadas`
  ADD PRIMARY KEY (`idhistorialPersonasCapacitadas`);

--
-- Indices de la tabla `historialresoluciones`
--
ALTER TABLE `historialresoluciones`
  ADD PRIMARY KEY (`id_historialResoluciones`),
  ADD KEY `fk_historialResoluciones_historial1_idx` (`historial_id_historial`);

--
-- Indices de la tabla `informaciongeneral`
--
ALTER TABLE `informaciongeneral`
  ADD PRIMARY KEY (`id_informacionGeneral`),
  ADD KEY `fk_informacionGeneral_organizaciones1_idx` (`organizaciones_id_organizacion`);

--
-- Indices de la tabla `informeactividades`
--
ALTER TABLE `informeactividades`
  ADD PRIMARY KEY (`id_informeActividades`),
  ADD KEY `fk_informeActividades_docentes1_idx` (`docentes_id_docente`),
  ADD KEY `fk_informeActividades_organizaciones1_idx` (`organizaciones_id_organizacion`);

--
-- Indices de la tabla `jornadasactualizacion`
--
ALTER TABLE `jornadasactualizacion`
  ADD PRIMARY KEY (`id_jornadasActualizacion`),
  ADD KEY `fk_jornadasActualizacion_solicitudes1_idx` (`solicitudes_id_solicitud`);
...
ALTER TABLE `municipios`
  ...
  ADD KEY `fk_municipios_departamentos1_idx` (`departamentos_id_departamento`);

--
-- Indices de la tabla `nits_db`
--
ALTER TABLE `nits_db`
  ADD PRIMARY KEY (`idnits_db`);
...
ALTER TABLE `observaciones`
  ...
  ADD KEY `fk_observaciones_solicitudes1_idx` (`solicitudes_id_solicitud`);

--
-- Indices de la tabla `observacionesdocente`
--
ALTER TABLE `observacionesdocente`
  ADD PRIMARY KEY (`id_observacionesDocente`),
  ADD KEY `fk_observacionesDocente_docentes1_idx` (`docentes_id_docente`);
...
ALTER TABLE `organizaciones`
  ADD PRIMARY KEY (`id_organizacion`,`numNIT`),
  ADD KEY `fk_registro_usuarios_idx` (`usuarios_id_usuario`);

--
-- Indices de la tabla `organizacioneshistorial`
--
ALTER TABLE `organizacioneshistorial`
  ADD PRIMARY KEY (`id_organizacionHistorial`);

--
-- Indices de la tabla `planmejoramiento`
--
ALTER TABLE `planmejoramiento`
  ADD PRIMARY KEY (`id_planMejoramiento`),
  ADD KEY `fk_planMejoramiento_organizaciones1_idx` (`organizaciones_id_organizacion`);

--
-- Indices de la tabla `programasavalar`
--
ALTER TABLE `programasavalar`
  ADD PRIMARY KEY (`id_programasAvalar`),
  ADD KEY `fk_programasAvalar_solicitudes1_idx` (`solicitudes_id_solicitud`);

--
-- Indices de la tabla `programasavaleconomia`
--
ALTER TABLE `programasavaleconomia`
  ADD PRIMARY KEY (`id_programasAvalEconomia`),
  ADD KEY `fk_programasAvalEconomia_solicitudes1_idx` (`solicitudes_id_solicitud`);

--
-- Indices de la tabla `registroeducativoprogramas`
--
ALTER TABLE `registroeducativoprogramas`
  ADD PRIMARY KEY (`id_registroEducativoPro`),
  ADD KEY `fk_registroEducativoProgramas_solicitudes1_idx` (`solicitudes_id_solicitud`);

--
-- Indices de la tabla `registrotelefonico`
--
ALTER TABLE `registrotelefonico`
  ADD PRIMARY KEY (`id_registroTelefonico`);

--
-- Indices de la tabla `resoluciones`
--
ALTER TABLE `resoluciones`
  ADD PRIMARY KEY (`id_resoluciones`),
  ADD KEY `fk_resoluciones_organizaciones1_idx` (`organizaciones_id_organizacion1`,`organizaciones_numNIT`);
...
ALTER TABLE `seguimiento`
  ...
  ADD KEY `fk_seguimiento_visitas1_idx` (`visitas_id_visitas`);

--
-- Indices de la tabla `seguimientosimple`
--
ALTER TABLE `seguimientosimple`
  ADD PRIMARY KEY (`id_seguimientoSimple`),
  ADD KEY `fk_seguimientoSimple_organizaciones1_idx` (`organizaciones_id_organizacion`);

--
-- Indices de la tabla `session_log`
--
ALTER TABLE `session_log`
  ADD PRIMARY KEY (`id_session_log`);
...
ALTER TABLE `solicitudes`
  ...
  ADD KEY `fk_solicitudes_organizaciones1_idx` (`organizaciones_id_organizacion`,`organizaciones_numNIT`);

--
-- Indices de la tabla `tiposcursoinformes`
--
ALTER TABLE `tiposcursoinformes`
  ADD PRIMARY KEY (`id_tiposCursoInformes`);
...
ALTER TABLE `tiposolicitud`
  ...
  ADD KEY `fk_tipoSolicitud_solicitudes1_idx` (`solicitudes_id_solicitud`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_usuarios_token1_idx` (`token_id_token`);
...
ALTER TABLE `visitas`
  ...
  ADD KEY `fk_visitas_organizaciones1_idx` (`organizaciones_id_organizacion`);
...
--
ALTER TABLE `administradores`
  MODIFY `id_administrador` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id del Administrador', AUTO_INCREMENT=100000016;
--
-- AUTO_INCREMENT de la tabla `antecedentesacademicos`
--
ALTER TABLE `antecedentesacademicos`
  MODIFY `id_antecedentesAcademicos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id tabla Antecedentes Academicos', AUTO_INCREMENT=84;
--
-- AUTO_INCREMENT de la tabla `archivos`
--
ALTER TABLE `archivos`
  MODIFY `id_archivo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Archivo', AUTO_INCREMENT=1560;
--
-- AUTO_INCREMENT de la tabla `archivosdocente`
--
ALTER TABLE `archivosdocente`
  MODIFY `id_archivosDocente` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Archivos Docente', AUTO_INCREMENT=2072;
--
...
--
-- AUTO_INCREMENT de la tabla `bateriaobservaciones`
--
ALTER TABLE `bateriaobservaciones`
  MODIFY `id_bateriaObservaciones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
--
-- AUTO_INCREMENT de la tabla `certificaciones`
--
ALTER TABLE `certificaciones`
  MODIFY `id_certificacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Certificacion';
--
-- AUTO_INCREMENT de la tabla `correosregistro`
--
ALTER TABLE `correosregistro`
  MODIFY `id_correosRegistro` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `datosaplicacion`
--
ALTER TABLE `datosaplicacion`
  MODIFY `id_datosAplicacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id tabla Datos Aplicacion', AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT de la tabla `datosbasicosprogramas`
--
ALTER TABLE `datosbasicosprogramas`
  MODIFY `id_datosBasicosProgramas` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id tabla datos basicos programas', AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT de la tabla `docentes`
--
ALTER TABLE `docentes`
  MODIFY `id_docente` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Docente', AUTO_INCREMENT=347;
--
-- AUTO_INCREMENT de la tabla `documentacionlegal`
--
ALTER TABLE `documentacionlegal`
  MODIFY `id_documentacionLegal` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id de la tabla Documentacion Legal', AUTO_INCREMENT=84;
--
...
--
ALTER TABLE `historial`
  MODIFY `id_historial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=683;
--
-- AUTO_INCREMENT de la tabla `historialresoluciones`
--
ALTER TABLE `historialresoluciones`
  MODIFY `id_historialResoluciones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=694;
--
-- AUTO_INCREMENT de la tabla `informaciongeneral`
--
ALTER TABLE `informaciongeneral`
  MODIFY `id_informacionGeneral` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id tabla informacion general', AUTO_INCREMENT=107;
--
-- AUTO_INCREMENT de la tabla `informeactividades`
--
ALTER TABLE `informeactividades`
  MODIFY `id_informeActividades` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `jornadasactualizacion`
--
ALTER TABLE `jornadasactualizacion`
  MODIFY `id_jornadasActualizacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Jornadas de Actualziacion', AUTO_INCREMENT=65;
--
-- AUTO_INCREMENT de la tabla `nits_db`
--
ALTER TABLE `nits_db`
  MODIFY `idnits_db` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;
--
-- AUTO_INCREMENT de la tabla `notificaciones`
--
ALTER TABLE `notificaciones`
  MODIFY `id_notificaciones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=829;
--
-- AUTO_INCREMENT de la tabla `observaciones`
--
ALTER TABLE `observaciones`
  MODIFY `id_observacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Observaciones', AUTO_INCREMENT=424;
--
-- AUTO_INCREMENT de la tabla `observacionesdocente`
--
ALTER TABLE `observacionesdocente`
  MODIFY `id_observacionesDocente` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `organizaciones`
  MODIFY `id_organizacion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Registro de la Organizacion', AUTO_INCREMENT=573;
--
-- AUTO_INCREMENT de la tabla `organizacioneshistorial`
--
ALTER TABLE `organizacioneshistorial`
  MODIFY `id_organizacionHistorial` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Registro de la Organizacion', AUTO_INCREMENT=729;
--
-- AUTO_INCREMENT de la tabla `planmejoramiento`
--
ALTER TABLE `planmejoramiento`
  MODIFY `id_planMejoramiento` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `programasavalar`
--
ALTER TABLE `programasavalar`
  MODIFY `id_programasAvalar` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Programas a Avalar', AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT de la tabla `programasavaleconomia`
--
ALTER TABLE `programasavaleconomia`
  MODIFY `id_programasAvalEconomia` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Programas Aval Economia Solidaria', AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `registroeducativoprogramas`
--
ALTER TABLE `registroeducativoprogramas`
  MODIFY `id_registroEducativoPro` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id tabla Registro educativo', AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `registrotelefonico`
--
ALTER TABLE `registrotelefonico`
  MODIFY `id_registroTelefonico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT de la tabla `resoluciones`
--
ALTER TABLE `resoluciones`
  MODIFY `id_resoluciones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
--
...
--
-- AUTO_INCREMENT de la tabla `seguimientosimple`
--
ALTER TABLE `seguimientosimple`
  MODIFY `id_seguimientoSimple` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `session_log`
--
ALTER TABLE `session_log`
  MODIFY `id_session_log` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id se Session Log', AUTO_INCREMENT=8041;
--
-- AUTO_INCREMENT de la tabla `solicitudes`
--
ALTER TABLE `solicitudes`
  MODIFY `id_solicitud` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Tabla Solicitudes', AUTO_INCREMENT=199;
--
-- AUTO_INCREMENT de la tabla `tiposcursoinformes`
--
ALTER TABLE `tiposcursoinformes`
  MODIFY `id_tiposCursoInformes` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tiposolicitud`
--
ALTER TABLE `tiposolicitud`
  MODIFY `id_tipoSolicitud` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id tabla tipo solicitud', AUTO_INCREMENT=116;
--
-- AUTO_INCREMENT de la tabla `token`
--
ALTER TABLE `token`
  MODIFY `id_token` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Token del usuario', AUTO_INCREMENT=200;
--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id del Usuario', AUTO_INCREMENT=200;
--
...
--
-- Filtros para la tabla `antecedentesacademicos`
--
ALTER TABLE `antecedentesacademicos`
  ADD CONSTRAINT `fk_antecedentesAcademicos_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`) REFERENCES `organizaciones` (`id_organizacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `archivos`
--
ALTER TABLE `archivos`
  ADD CONSTRAINT `fk_archivos_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`) REFERENCES `organizaciones` (`id_organizacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `archivosdocente`
--
ALTER TABLE `archivosdocente`
  ADD CONSTRAINT `fk_archivosDocente_docentes1` FOREIGN KEY (`docentes_id_docente`) REFERENCES `docentes` (`id_docente`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `asistentes`
--
ALTER TABLE `asistentes`
  ADD CONSTRAINT `fk_asistentes_informeActividades1` FOREIGN KEY (`informeActividades_id_informeActividades`) REFERENCES `informeactividades` (`id_informeActividades`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `certificaciones`
--
ALTER TABLE `certificaciones`
  ADD CONSTRAINT `fk_certificaciones_informeActividades1` FOREIGN KEY (`informeActividades_id_informeActividades`) REFERENCES `informeactividades` (`id_informeActividades`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datosaplicacion`
--
ALTER TABLE `datosaplicacion`
  ADD CONSTRAINT `fk_datosAplicacion_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `datosbasicosprogramas`
--
ALTER TABLE `datosbasicosprogramas`
  ADD CONSTRAINT `fk_datosBasicosProgramas_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `docentes`
--
ALTER TABLE `docentes`
  ADD CONSTRAINT `fk_docentes_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`) REFERENCES `organizaciones` (`id_organizacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `documentacionlegal`
--
ALTER TABLE `documentacionlegal`
  ADD CONSTRAINT `fk_documentacionLegal_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `encuesta`
--
ALTER TABLE `encuesta`
  ADD CONSTRAINT `fk_encuesta_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `historialresoluciones`
--
ALTER TABLE `historialresoluciones`
  ADD CONSTRAINT `fk_historialResoluciones_historial1` FOREIGN KEY (`historial_id_historial`) REFERENCES `historial` (`id_historial`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `informaciongeneral`
--
ALTER TABLE `informaciongeneral`
  ADD CONSTRAINT `fk_informacionGeneral_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`) REFERENCES `organizaciones` (`id_organizacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `informeactividades`
--
ALTER TABLE `informeactividades`
  ADD CONSTRAINT `fk_informeActividades_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`) REFERENCES `organizaciones` (`id_organizacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `jornadasactualizacion`
--
ALTER TABLE `jornadasactualizacion`
  ADD CONSTRAINT `fk_jornadasActualizacion_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `fk_municipios_departamentos1` FOREIGN KEY (`departamentos_id_departamento`) REFERENCES `departamentos` (`id_departamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `observaciones`
--
ALTER TABLE `observaciones`
  ADD CONSTRAINT `fk_observaciones_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `observacionesdocente`
--
ALTER TABLE `observacionesdocente`
  ADD CONSTRAINT `fk_observacionesDocente_docentes1` FOREIGN KEY (`docentes_id_docente`) REFERENCES `docentes` (`id_docente`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `organizaciones`
--
ALTER TABLE `organizaciones`
  ADD CONSTRAINT `fk_registro_usuarios` FOREIGN KEY (`usuarios_id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `planmejoramiento`
--
ALTER TABLE `planmejoramiento`
  ADD CONSTRAINT `fk_planMejoramiento_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`) REFERENCES `organizaciones` (`id_organizacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `programasavalar`
--
ALTER TABLE `programasavalar`
  ADD CONSTRAINT `fk_programasAvalar_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `programasavaleconomia`
--
ALTER TABLE `programasavaleconomia`
  ADD CONSTRAINT `fk_programasAvalEconomia_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `registroeducativoprogramas`
--
ALTER TABLE `registroeducativoprogramas`
  ADD CONSTRAINT `fk_registroEducativoProgramas_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `resoluciones`
--
ALTER TABLE `resoluciones`
  ADD CONSTRAINT `fk_resoluciones_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion1`,`organizaciones_numNIT`) REFERENCES `organizaciones` (`id_organizacion`, `numNIT`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `seguimiento`
--
ALTER TABLE `seguimiento`
  ADD CONSTRAINT `fk_seguimiento_visitas1` FOREIGN KEY (`visitas_id_visitas`) REFERENCES `visitas` (`id_visitas`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `seguimientosimple`
--
ALTER TABLE `seguimientosimple`
  ADD CONSTRAINT `fk_seguimientoSimple_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`) REFERENCES `organizaciones` (`id_organizacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `solicitudes`
--
ALTER TABLE `solicitudes`
  ADD CONSTRAINT `fk_solicitudes_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`,`organizaciones_numNIT`) REFERENCES `organizaciones` (`id_organizacion`, `numNIT`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `tiposolicitud`
--
ALTER TABLE `tiposolicitud`
  ADD CONSTRAINT `fk_tipoSolicitud_solicitudes1` FOREIGN KEY (`solicitudes_id_solicitud`) REFERENCES `solicitudes` (`id_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_usuarios_token1` FOREIGN KEY (`token_id_token`) REFERENCES `token` (`id_token`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `visitas`
--
ALTER TABLE `visitas`
  ADD CONSTRAINT `fk_visitas_organizaciones1` FOREIGN KEY (`organizaciones_id_organizacion`) REFERENCES `organizaciones` (`id_organizacion`) ON DELETE NO ACTION ON UPDATE NO ACTION;
